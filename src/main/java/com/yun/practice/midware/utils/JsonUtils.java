...
public class JsonUtils {
    ...
    static {
        ...
        MAPPER_HAS_NULL.registerModule(new JavaTimeModule());
        MAPPER_HAS_NULL.disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
    ...
    public static Map toMap(String jsonStr, Class<?> keyClass, Class<?> valueClass) {
        try {
            ...
            LOGGER.warn("parese error,the json is:" + jsonStr);
